<x-layout>
    ...
    <div class="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
        ...
        <div class="relative mt-5 overflow-hidden transition-all duration-500 border border-transparent rounded-lg shadow-2xl group hover:shadow-xl hover:border-emas">
            ...
            <img 
                src="{{asset('photo/'. $informasi->foto)}}" 
        ...
        <div class="flex flex-col items-start justify-between gap-3 mt-6 sm:flex-row sm:items-center">
            <div class="flex items-center space-x-2">
                ...
                <p class="text-sm">Upload oleh <span class="font-semibold ">{{$informasi->admin->name}}</span></p>
            </div>
        ...
        <article class="mt-10 prose prose-lg max-w-none">
            ...
            <div class="space-y-6 font-serif text-lg leading-relaxed text-justify ">
