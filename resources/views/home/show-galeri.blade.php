<x-layout>
    ...
    <div class="relative overflow-hidden transition-all duration-500 border border-transparent shadow-2xl group rounded-2xl hover:shadow-xl hover:border-emas">
